...
function crearInterfazPedido() {
    ...
    // Evitamos crear el carrito dos veces
    if (document.getElementById("carrito-pedido")) {
        return;
    }


    const carritoHTML = document.createElement("section");

    carritoHTML.id = "carrito-pedido";

    carritoHTML.className = "seccion carrito-seccion";
...
function continuarPedido() {
    ...
    // Si el formulario ya existe, solamente bajamos hasta él
    const existente = document.getElementById("datos-pedido");
    ...
    // Buscar la sección del carrito
    const carritoSeccion =
        document.getElementById("carrito-pedido");

    if (!carritoSeccion) {
        alert("No se encontró la sección del pedido.");
        return;
    }
    ...
    formulario.id = "datos-pedido";
    formulario.className = "datos-pedido";
    ...
    // Agregar formulario al carrito
    carritoSeccion.appendChild(formulario);
...
function prepararPedido() {
    ...
    // Obtener teléfono
    const campoTelefono = document.getElementById("telefono-cliente");
    ...
    // ==========================================
    // VALIDAR SUCURSAL O DOMICILIO
    // ==========================================

    let entregaTexto = "";

    if (tipoEntrega.value === "sucursal") {
...
function mostrarResumenFinal() {
    ...
    const campoTelefono =
        document.getElementById("telefono-cliente");
...
function enviarPedidoGoogleSheets(
    pedido
) {
